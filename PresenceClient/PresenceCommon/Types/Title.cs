...
public class Title
{
    public Title(byte[] bytes)
    {
        ...
        {
            if (Utils.SwitchOverrides.ContainsKey($"0{ProgramId:x}") &&
                Utils.SwitchOverrides[$"0{ProgramId:x}"].CustomName != null)
    ...
    {
        [MarshalAs(UnmanagedType.U8)] public readonly ulong magic;
        [MarshalAs(UnmanagedType.U8)] public readonly ulong programId;
